...
export default function SecretCard5() {
    const questions = [
        {
            description:
        ...
        {
            description:
                "SEMrush & Ahrefs : Analyse SEO et stratégie concurrentielle",
        },
        {
            description:
                "Feedback clients & A/B testing : Amélioration de l’expérience utilisateur",
        },
    ];
            ...
            <section className="mx-auto max-w-7xl px-5 py-16 md:px-10 overflow-hidden">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-[800px] text-para">
                        Une bonne stratégie digitale repose sur l’analyse des performances et l’optimisation continue.
            ...
            <section className="bg-bg text-center py-6">
                <div className="container mx-auto">
                    ...
                    <p className="mx-auto mt-6 max-w-[800px] text-para">
                        <span className="font-bold text-para">Astuce SEO :</span> Mettez en place des CTA (Call-To-Action) clairs et optimisez vos pages avec des termes comme “comment améliorer son taux de conversion”.
                    </p>
                </div>
            </section>
        </div>
